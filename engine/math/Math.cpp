...
Math * Math::_instance = NULL;

Random * Math::__randomizer = NULL;

float * Math::m_sin = NULL;
float * Math::m_easeQuadIn = NULL;
float * Math::m_easeQuadOut = NULL;
float * Math::m_easeQuadInOut = NULL;
float * Math::m_easeCubeIn = NULL;
float * Math::m_easeCubeOut = NULL;
float * Math::m_easeCubeInOut = NULL;
float * Math::m_easeQuartIn = NULL;
float * Math::m_easeQuartOut = NULL;
float * Math::m_easeQuartInOut = NULL;
float * Math::m_easeQuintIn = NULL;
float * Math::m_easeQuintOut = NULL;
float * Math::m_easeQuintInOut = NULL;
float * Math::m_easeElasticIn = NULL;
float * Math::m_easeElasticOut = NULL;
float * Math::m_easeElasticInOut = NULL;
float * Math::m_easeBackIn = NULL;
float * Math::m_easeBackOut = NULL;
float * Math::m_easeBackInOut = NULL;
float * Math::m_easeBounceIn = NULL;
float * Math::m_easeBounceOut = NULL;
float * Math::m_easeBounceInOut = NULL;
...
void Math::randomize(long newSeed)
{
...
int Math::randomInf(float Low, float High)
{
    return __randomizer->randomInf(Low, High);
}

int Math::randomIn(int Low, int High)
{
    return __randomizer->randomIn(Low, High);
}

// Modeled after the line y = x
double Math::LinearInterpolation(double p)
{
    return p;
}

// Modeled after the parabola y = x^2
double Math::QuadraticEaseIn(double p)
{
    return p * p;
}

// Modeled after the parabola y = -x^2 + 2x
double Math::QuadraticEaseOut(double p)
{
    return -(p * (p - 2));
}
...
double Math::QuadraticEaseInOut(double p)
{
    if(p < 0.5)
    {
        return 2 * p * p;
...
double Math::CubicEaseIn(double p)
{
    return p * p * p;
}

// Modeled after the cubic y = (x - 1)^3 + 1
double Math::CubicEaseOut(double p)
{
    double f = (p - 1);
    return f * f * f + 1;
}
...
double Math::CubicEaseInOut(double p)
{
    if(p < 0.5)
    {
        return 4 * p * p * p;
...
double Math::QuarticEaseIn(double p)
{
    return p * p * p * p;
}

// Modeled after the quartic y = 1 - (x - 1)^4
double Math::QuarticEaseOut(double p)
{
    double f = (p - 1);
    return f * f * f * (1 - p) + 1;
}
...
double Math::QuarticEaseInOut(double p)
{
    if(p < 0.5)
    {
        return 8 * p * p * p * p;
...
double Math::QuinticEaseIn(double p)
{
    return p * p * p * p * p;
}

// Modeled after the quintic y = (x - 1)^5 + 1
double Math::QuinticEaseOut(double p)
{
    double f = (p - 1);
    return f * f * f * f * f + 1;
}
...
double Math::QuinticEaseInOut(double p)
{
    if(p < 0.5)
    {
        return 16 * p * p * p * p * p;
...
double Math::SineEaseIn(double p)
{
    return sin((p - 1) * M_PI_2) + 1;
}

// Modeled after quarter-cycle of sine wave (different phase)
double Math::SineEaseOut(double p)
{
    return sin(p * M_PI_2);
}

// Modeled after half sine wave
double Math::SineEaseInOut(double p)
{
    return 0.5 * (1 - cos(p * M_PI));
}

// Modeled after shifted quadrant IV of unit circle
double Math::CircularEaseIn(double p)
{
    return 1 - sqrt(1 - (p * p));
}

// Modeled after shifted quadrant II of unit circle
double Math::CircularEaseOut(double p)
{
    return sqrt((2 - p) * p);
}
...
double Math::CircularEaseInOut(double p)
{
    if(p < 0.5)
    {
...
double Math::ExponentialEaseIn(double p)
{
    return (p == 0.0) ? p : pow(2, 10 * (p - 1));
}

// Modeled after the exponential function y = -2^(-10x) + 1
double Math::ExponentialEaseOut(double p)
{
...
double Math::ExponentialEaseInOut(double p)
{
...
double Math::ElasticEaseIn(double p)
{
    return sin(13 * M_PI_2 * p) * pow(2, 10 * (p - 1));
}

// Modeled after the damped sine wave y = sin(-13pi/2*(x + 1))*pow(2, -10x) + 1
double Math::ElasticEaseOut(double p)
{
...
double Math::ElasticEaseInOut(double p)
{
    if(p < 0.5)
    {
...
double Math::BackEaseIn(double p)
{
    return p * p * p - p * sin(p * M_PI);
}

// Modeled after overshooting cubic y = 1-((1-x)^3-(1-x)*sin((1-x)*pi))
double Math::BackEaseOut(double p)
{
    double f = (1 - p);
...
double Math::BackEaseInOut(double p)
{
    if(p < 0.5)
    {
        double f = 2 * p;
...
double Math::BounceEaseIn(double p)
{
    return 1 - BounceEaseOut(1 - p);
}

double Math::BounceEaseOut(double p)
{
    if(p < 4/11.0)
    {
        return (121 * p * p)/16.0;
...
double Math::BounceEaseInOut(double p)
{
    if(p < 0.5)
    {
...
void Math::InitLinearInterpolation(){}
void Math::InitQuadraticEaseIn(){}
void Math::InitQuadraticEaseOut(){}
void Math::InitQuadraticEaseInOut(){}
void Math::InitCubicEaseIn(){}
void Math::InitCubicEaseOut(){}
void Math::InitCubicEaseInOut(){}
void Math::InitQuarticEaseIn(){}
void Math::InitQuarticEaseOut(){}
void Math::InitQuarticEaseInOut(){}
void Math::InitQuinticEaseIn(){}
void Math::InitQuinticEaseOut(){}
void Math::InitQuinticEaseInOut(){}
void Math::InitSineEaseIn(){}
void Math::InitSineEaseOut(){}
void Math::InitSineEaseInOut(){}
void Math::InitCircularEaseIn(){}
void Math::InitCircularEaseOut(){}
void Math::InitCircularEaseInOut(){}
void Math::InitExponentialEaseIn(){}
void Math::InitExponentialEaseOut(){}
void Math::InitExponentialEaseInOut(){}
void Math::InitElasticEaseIn(){}
void Math::InitElasticEaseOut(){}
void Math::InitElasticEaseInOut(){}
void Math::InitBackEaseIn(){}
void Math::InitBackEaseOut(){}
void Math::InitBackEaseInOut(){}
void Math::InitBounceEaseIn(){}
void Math::InitBounceEaseOut(){}
void Math::InitBounceEaseInOut(){}
